...
const socialLinks: SocialLink[] = [
    ...
    {
        name: 'Upwork',
        href: 'https://www.upwork.com/fl/~0153b1a87b49beb941?mp_source=share',
            ...
            {socialLinks.map((social) => (
                ...
                >
                    <div className="relative w-full sm:w-36 h-12 sm:h-14">
                        ...
                        <div className="absolute inset-0 rounded-md bg-[#141414] border border-[#252525] transition-opacity duration-300 group-hover:opacity-0" />
