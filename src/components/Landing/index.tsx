...
const Landing = () => {
    ...
    const technologies = Array.from(
        new Set(
            PortfolioAPI.data.portfolio.flatMap((project) =>
                project.stack.map((tech) => tech.title)
            )
        )
    ).map((title) => ({ title }));
    ...
    const renderFeaturedWorks = () => {
        ...
        const dataset = filterFeaturedWorks.map((content: any, index: string) => {
            return (
                        ...
                        <div className="relative z-30">
                            <div className="flex flex-col lg:flex-row items-center gap-6 p-6">
                                ...
                                <div className="flex-1 flex flex-col gap-4 py-2">
                                    ...
                                    <div className="flex justify-center lg:justify-start mt-auto mt-8">
    ...
    return (
        <Fragment>
                    ...
                    <div className="w-max">
                        <div className="flex flex-col font-inter gap-y-6">
                            ...
                            <p>
                                ...
                                curiosity. From 2017 I&apos;ve worked as a freelancer. Since 2019
                                I&apos;ve been working as a Professional Web Developer. I&apos;ve
                                sharpened my skills across various tech stacks and frameworks
                                through freelancing and contract work, always aiming to push
                                technical boundaries and foster community growth. I&apos;m keen on
                                exploring new opportunities and collaborations—let&apos;s connect
            ...
            <section>
                ...
                <div className="gap-4 grid grid-cols-1 xl:grid-cols-2">{renderFeaturedWorks()}</div>
