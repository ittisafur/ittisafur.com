...
export const AnimationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const animateGradientText = (element: Element) => {
  ...
  const animateBlurToSharp = (element: Element) => {
  ...
  const animateZoomFade = (element: Element) => {
  ...
  const animateLineByLine = (element: Element) => {
